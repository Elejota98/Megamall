...
namespace BlockAndPass.PPMWinform
{
    public partial class CopiaFactura : Form
    {
        ...
        private void btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            string strCadSQL1 = "SELECT IDTIPOPAGO FROM  T_PAGOS WHERE  NUMEROFACTURA = '" + NUMFACT + "' and IdModulo='"+MODULO+"' ";
            ...
            if (TIPO == "1")
            {
                ...
                this.dataTable1TableAdapter1.Fill(this.dataSetCopia.DataTable1, NUMFACT,MODULO);
                //this.DATA
            ...
            {
                CopiaFacturaM popup = new CopiaFacturaM(tbnumerofactura.Text, cboModulo.SelectedItem.ToString());
                popup.ShowDialog();
