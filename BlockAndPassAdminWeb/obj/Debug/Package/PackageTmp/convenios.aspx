    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function btnEditar_click(e) {
	            ...
	            $('#fechaInicioModal').val(fecha);
	            $('#fechaFinModal').val(fechaFin);
	        ...
	        function btnModalGuardar_click() {
	            if ($('.modal-title').html() == 'Crear') {
	             ...
	             //LINEAS BORRADAS
	                ...
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/CrearConvenio?&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + $('#fechaInicioModal').val() + "&fechaFinal=" + $('#fechaFinModal').val() + "&minuto=" + $('#minutoModal').val() + "&estado=" + activo,
	               //     url: "DataService.asmx/CrearConvenio?&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + date + "&fechaFinal=" + date2 + "&minuto=" + $('#minutoModal').val() + "&estado=" + activo,
	                    data: "",
	                    contentType: "application/json",
	                    dataType: "json",
	                    success: function (msg) {
	                ...
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/ActualizarConvenio?idConvenio=" + $('#idConvenioModal').val() + "&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + $('#fechaInicioModal').val() + "&fechaFinal=" + $('#fechaFinModal').val() + "&minuto=" + $('#minutoModal').val() + "&estado=" + activo,
	                 //   url: "DataService.asmx/ActualizarConvenio?idConvenio=" + $('#idConvenioModal').val() + "&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + date + "&fechaFinal=" + date2 + "&minuto=" + $('#minutoModal').val() + "&estado=" + activo,
	                    data: "",
	                    contentType: "application/json",
	                    dataType: "json",
	                    success: function (msg) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-input" type="time" name="date1" value="" id="fechaInicioModal">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-input" type="time" name="date2" value="" id="fechaFinModal">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label>Minutos</label>
                                    <input type="number" min="1" class="form-control border-input" value="" id="minutoModal">
                                </div>
                            </div>
                             </div>
