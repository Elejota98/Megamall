<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="borrarinfotarget.aspx.cs" Inherits="BlockAndPass.AdminWeb.borrarinfotarget" %>
    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function btnBorrar_click() {
	            if (confirm('¿Está seguro que desea borrar información de la tarjeta?')) {
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/ObtenerValorParametroxNombre?nombre=claveTarjeta&idEstacionamiento=" + $("#cbEstacionamiento").val(),
	                    data: "",
	                    ...
	                    success: function (msg) {
	                        ...
	                        if (obj != '') {
	                            $.ajax({
	                                type: "GET",
	                                url: "http://localhost:8080/ReaderLocalService.svc/reader/CleanCard?password=" + obj,
	                                data: "",
	                                contentType: "application/json",
	                                dataType: "json",
	                                success: function () {
	                                    confirmaCambios(true, 'INFORMACION BORRADA CORRECTAMENTE');
	                                },
	                                error: function () {
	                                    confirmaCambios(false, 'Error al consumir servicio LOCAL.');
	                                }
	        ...
	        function btnBorrar_Repoclick() {
	            if (confirm('¿Está seguro que desea borrar reposición?')) {
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/ObtenerValorParametroxNombre?nombre=claveTarjeta&idEstacionamiento=" + $("#cbEstacionamiento").val(),
	                    data: "",
	                    ...
	                    success: function (msg) {
	                        ...
	                        if (obj != '') {
	                            $.ajax({
	                                type: "GET",
	                                url: "http://localhost:8080/ReaderLocalService.svc/reader/CleanRepo?password=" + obj,
	                                data: "",
	                                contentType: "application/json",
	                                dataType: "json",
	                                success: function () {
	                                    confirmaCambios(true, 'REPOSICION BORRADA CORRECTAMENTE');
	                                },
	                                error: function () {
	                                    confirmaCambios(false, 'Error al consumir servicio LOCAL.');
	                                }
	        ...
	        -->
    	        ...
    	        <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <li class="active" id="navBorrarTarjetas">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-xs-push-12">
                                                    <div class="pull-left">
                                                        <label></label>
                                                        <button type="button" id="Button3" class="btn btn-default" onclick="btnBorrar_Repoclick();">
                                                            <span class="icon-warning ti-credit-card"></span> Eliminar reposición
                                                        </button>  
                                                    </div>
                                            </div>
                                                <div class="col-xs-push-12">
                                                    <div class="pull-right">
                                                        <label></label>
                                                        <button type="button" id="Button2" class="btn btn-default" onclick="btnBorrar_click();">
                                                            <span class="icon-warning ti-credit-card"></span> Borrar info
                                                        </button> 
                                                    </div>
                                            </div>
